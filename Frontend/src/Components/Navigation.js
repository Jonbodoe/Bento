...
const Navigation = (props) => {
    ...
    return (
        // <div className={themeMode.state? 'e' : 'lightmode'}>
            <nav className={`navbar navbar-expand-lg py-2 text-right shadow-sm px-5 container-fluid d-flex justify-content-between navbar-${mode.state.themeMode} bg-${mode.state.themeMode} border-bottom border-${mode.state.BgSecondaryClass}`}>
                <div className="align-self-center">
                </div>
                <div className="d-flex">
                    <div className="text-left px-3">
                        <h2 className="font-weight-bold navbar-brand">Bento</h2>
                    ...
                    <div className="px-2 border-left border-secondary align-self-center">
                        ...
                        {/* <button type="button" className="btn btn-primary" onClick={()=> mode.dispatch({type: 'darkmode'})}>
                            {
